...
The project was created using the _create-react-app_ tool. This is done by
running the command `npx create-react-app <folder_name>`. The following content
was generated by running that command.
